...
When a call is accepted, the local bridge should immediately trigger the voice agent to greet the caller before the caller speaks: `Hi! My name is {Telegram account name}. I'm here to assist you.`
